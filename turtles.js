...
let syncopatedTurtle = new Turtle();

syncopatedTurtle.walk = function() {
    this.s = 0.5;
    let headingModifier = map(this.currentValue, 0, 0.5, -PI * this.s, PI * this.s);
...
let vallottonTurtle = new Turtle();

vallottonTurtle.walk = function() {
    this.s = 5;
...
let nonCartesianTurtle = new Turtle();

nonCartesianTurtle.walk = function() {
    this.s = 0.5;
    let headingModifier = map(this.currentValue, 0, 0.5, -PI * this.s, PI * this.s);
...
let secondTurtleCartesian = new Turtle();

secondTurtleCartesian.walk = function() {
    this.s = 0.5;
    let headingModifier = map(this.currentValue, 0, 0.5, -PI * this.s, PI * this.s);
...
let firstTurtleCartesian = new Turtle();

firstTurtleCartesian.walk = function() {
    this.s = 0.5;
    let headingModifier = map(this.currentValue, 0, 0.5, -PI * this.s, PI * this.s);
...
let starTurtleCartesian = new Turtle();

starTurtleCartesian.walk = function() {
    this.s = 0.5;
    let headingModifier = map(this.currentValue, 0, 0.5, -PI * this.s, PI * this.s);
